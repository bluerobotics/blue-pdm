# BluePDM SolidWorks Service

A standalone service that provides SolidWorks file operations for the BluePDM Electron app.
...
│      │ IPC → Main Process                                   │
│      ▼                                                      │
│  Spawns BluePDM.SolidWorksService.exe                       │
│      │                                                      │
│      │ JSON stdin/stdout                                    │
│      ▼                                                      │
...
# Build the service
dotnet build BluePDM.SolidWorksService/BluePDM.SolidWorksService.csproj -c Release
```

Output: `BluePDM.SolidWorksService/bin/Release/BluePDM.SolidWorksService.exe`

## Command Line Usage

```bash
# Interactive mode (reads JSON from stdin)
BluePDM.SolidWorksService.exe --keep-sw-running

# Single command mode
BluePDM.SolidWorksService.exe --command '{"action":"ping"}'
```
...
MIT - Part of the BluePDM project.
