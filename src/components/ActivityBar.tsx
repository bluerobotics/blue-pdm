    ...
    <div className="py-[2px] px-[6px]">
      <button
        ...
        className={`relative h-10 w-full flex items-center gap-3 px-[9px] rounded-lg transition-colors overflow-hidden ${
          isActive
            ? 'text-white bg-pdm-highlight'
            : 'text-pdm-fg-muted hover:text-white hover:bg-pdm-highlight/50'
        }`}
      >
        ...
        <div className="relative w-[22px] h-[22px] flex items-center justify-center flex-shrink-0">
          {icon}
          {badge && badge > 0 && (
            <span className="absolute -top-1 -right-1.5 min-w-[14px] h-[14px] px-0.5 bg-pdm-accent text-white text-[9px] font-bold rounded-full flex items-center justify-center">
              {badge > 99 ? '!' : badge}
            </span>
          )}
        </div>
    ...
    <div className="py-[2px] pb-[6px] px-[6px]">
      <div className="relative">
        <button
          ...
          className="w-full h-10 flex items-center px-[9px] rounded-lg text-pdm-fg-muted hover:text-pdm-fg hover:bg-pdm-highlight/50 transition-colors"
        >
          <PanelLeft size={18} />
        </button>
