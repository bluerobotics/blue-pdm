...
- Branch `main` is **ahead of `origin/main` by 6 commits** (`8e794f5`, `6c315e3`, `049a704`,
  `73b80a1`, `cf3684d`, `7aca01f`). `git rev-list --left-right --count origin/main...HEAD` returns
  `0  6` — nothing behind.
